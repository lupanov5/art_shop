...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_showMoreStiles__WEBPACK_IMPORTED_MODULE_5__["default"])('#styles .row', '.button-styles');
...
var showMoreStiles = function showMoreStiles(wrapper, trigger) {
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch url: ".concat(url, ", status: ").concat(res.status));
